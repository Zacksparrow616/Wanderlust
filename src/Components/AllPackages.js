...
import { allPackagesURL } from "../BackendURL";
...
class AllPackages extends Component {
    ...
    getDestinations = () => {
        Axios.get(allPackagesURL).then(response => {
    ...
    render() {
        ...
        return(
            <div className = "container-fluid allBg" style = {{"padding": "50px 10px 10px 10px"}}>
                ...
                {this.state.destinations.filter(destination => {
                    ...
                    <div key = {destination.destinationId}>
                        <div className = "container rounded bg-light mx-auto  shadow-lg p-3 mb-5 bg-white rounded" style = {{"padding": "20px 20px 20px 20px"}}>
